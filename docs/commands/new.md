...
2. **Determine track name**: Ask user for the track name (e.g., `musculoskeletal-care`, `sleep-optimizer`). This becomes the directory name under `./skill-conductor/tracks/<name>/`. No date prefix — the creation date is recorded in metadata.json.
...
9. **Update tracks-registry**: Add the new track to `./skill-conductor/tracks-registry.md`
