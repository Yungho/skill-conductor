...
1. **Check workspace**: Read `.claude/CLAUDE.md` to determine workspace directory name (default: `skill-conductor/`). Create workspace directory and `tracks/` subdirectory in the current project if they don't exist
